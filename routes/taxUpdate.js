   ...
   //  console.log(req.body.password+req.body.adminName+req.body.companyID+ " "+ md5Password);
    ...
    con.connect(function(err) {
          ...
          console.log("Connected!");
           ...
           dbquery = "UPDATE tax SET taxType='"+taxType+"', taxCode='"+taxCode+"', taxDescription='"+ taxDescription+ "', taxRate='"+ taxRate +"', remark='"+ remark +"' WHERE companyID='"+ companyID+ "' and taxID='"+ taxID +"'";
           console.log(dbquery);
