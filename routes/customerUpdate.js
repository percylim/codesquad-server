...
router.post('/', function(req, res, next) {
 ...
 console.log('✅ customerUpdate POST triggered');
  console.log(req.body);
  //res.send("Customer update received");
  ...
  dbquery = "UPDATE suppCustAcct SET supplierName='"+ supplierName + "',  acctType= '"+ acctType + "', tel1= '"+ tel1 + "', tel2='"+ tel2 + "', handPhone='"+ handPhone + "', fax='"+ fax + "', email='"+ email + "', website='"+ website + "', address1='"+ address1 + "', address2='"+ address2 + "', city='"+ city + "', postCode='"+ postcode+ "', state='"+ state + "', country='"+ country + "', paymentTerm='"+ paymentTerm + "', creditLimit='"+ creditLimit + "', personContact='"+ personContact + "', glNo='"+glNo+"', glSub='"+glSub+"', glType='"+glType+"' WHERE companyID = '"+companyID+"' and supplierID = '"+supplierID+"'"
