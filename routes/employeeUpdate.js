...
dbquery = "UPDATE employee SET employeeName='"+ employeeName + "', telNo='"+ telNo + "', employDate='"+ employDate + "', password = '"+md5Password+"' WHERE companyID = '"+companyID+"' and employeeNo = '"+employeeNo+"'"
 console.log(dbquery);
