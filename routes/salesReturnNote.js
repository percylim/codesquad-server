...
// update purchase Invoice
 ...
 //  taxDescription = invData[i].taxDescription;
   ...
   netTotal = parseFloat(invData[i].itemNetTotal);
   txnTotal+=parseFloat(invData[i].ItemNetTotal);
   txnTaxTotal+=parseFloat(invData[i].itemTax);
   txnNetTotal+=parseFloat(invData[i].itemNetTotal);
   productID = invData[i].productID;
   productName=invData[i].productName;
   barcode = invData[i].barcode;
   returnQuantity=parseFloat(invData[i].returnQuantity);
   unit = invData[i].unit;
   unitPrice = parseFloat(invData[i].unitPrice);
