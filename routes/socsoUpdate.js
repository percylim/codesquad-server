   ...
   //  console.log(req.body.password+req.body.adminName+req.body.companyID+ " "+ md5Password);
    ...
    con.connect(function(err) {
          ...
          console.log("Connected!");
           ...
           dbquery = "UPDATE socso SET startSalary ='"+ startSalary +"', endSalary='"+ endSalary +"', companyRate='"+ companyRate +"', employeeRate='"+ employeeRate + "', remark='"+ remark +"', sortSalary='"+ startSalary +"' WHERE companyID='"+ companyID+ "' and id='"+ id +"'";
           console.log(dbquery);
           con.query(dbquery, function(err, row) {
                  ...
                  if (err) {
                   ...
                   // return;
                            ...
                            console.log("SOCSO Racord Updated")
                            res.send("Success");
                           }
