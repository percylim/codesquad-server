...
//  console.log("Bank Account: "+bankAcctNo);
  ...
  dbquery = "UPDATE bankAcct SET bankName='"+ bankName +"', address1='"+ address1 +"', address2='"+ address2 +"', postcode='"+ postcode +"', city='"+ city +"', state='"+ state +"', country='"+ country +"', tel1='"+ tel1 +"', tel2='"+ tel2 +"', fax='"+ fax +"', email='"+ email +"' WHERE companyID='"+ companyID + "' AND bankID='"+ bankID +"' AND bankAcctNo='"+ bankAcctNo +"'"
