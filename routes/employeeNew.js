...
dbquery = "INSERT INTO employee (companyID, companyName, employeeNo, employeeName, telNo, employDate, password) VALUE('" + companyID + "', '"+ companyName +"', '"+ employeeNo + "', '"+ employeeName + "', '"+ telNo +"', '"+ employDate +"', '"+ md5Password +"')"
 console.log(dbquery);
                          con.query(dbquery, function(err, row) {
