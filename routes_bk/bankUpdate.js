          ...
          con.query(dbquery, function(err, row) {
                  ...
                  if (err) {
                   ...
                   // return;
                    ...
                    if (row.length===0) {   // 2
                     console.log("Bank Account not existed");
                     res.send(alert("Bank Account not existed, please re-entry"))
                    } else  {   // create new record
  dbquery = "UPDATE bankAcct SET bankName='"+ bankName +"', address1='"+ address1 +"', address2='"+ address2 +"', postcode='"+ postcode +"', city='"+ city +"', state='"+ state +"', country='"+ country +"', tel1='"+ tel1 +"', tel2='"+ tel2 +"', fax='"+ fax +"', email='"+ email +"', glNo='"+ glNo+ "', glSub='"+ glSub +"', glType='"+ glType +"' WHERE companyID='"+ companyID + "' AND bankID='"+ bankID +"' AND bankAcctNo='"+ bankAcctNo +"'"
