...
router.post('/', function(req, res, next) {
  ...
  dbquery = "INSERT INTO product (companyID, productID, sku, barcode, productName, description, unit, unitPrice, categoryID, productImage, date_created) VALUE('" + companyID + "', '"+ productID +"', '"+ sku + "', '"+ barcode + "', '"+ productName + "', '"+ description +"', '"+ unit + "', '" + unitPrice +"', '"+ categoryID +"', '"+ productImage + "', CURDATE())"
